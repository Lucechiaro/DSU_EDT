...
Процедура СформироватьОтчет() Экспорт
	...
	ОбщийКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "ДатаОтчета", Отчет.ДатаОтчета);
	ОбщийКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "СтатьяДДС", Отчет.СтатьяДДС);
	ОбщийКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "КоличествоМесяцев", Отчет.КоличествоМесяцев);
