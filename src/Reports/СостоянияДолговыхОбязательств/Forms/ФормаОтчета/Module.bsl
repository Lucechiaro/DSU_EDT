...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	СтруктураРасшифровки = ОбщегоНазначения.ПолучитьСтруктуруРасшифровки(Расшифровка, ЭтаФорма.ДанныеРасшифровки);
...
Процедура СформироватьОтчетНаСервере()
	...
	ОбщийКлиентСервер.УстановитьПараметрДанных(ИсполняемыеНастройки.ПараметрыДанных, "Дата", ОтчетОбъект.Дата);
