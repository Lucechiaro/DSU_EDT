...
Функция СформироватьОтчетСКД() Экспорт 
	...
	ОбщийКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "НачалоПериода", НачалоПериода);
	ОбщийКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "КонецПериода", КонецПериода);
	ОбщийКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "СтатьяДДС", СтатьяДДС);
