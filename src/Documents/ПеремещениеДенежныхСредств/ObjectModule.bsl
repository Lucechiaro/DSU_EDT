...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	//Если КурсДействуетДляИсходнойВалюты Тогда
	...
	Если УчитыватьВРасходах Тогда
		...
		Если Валюта <> ОбщийПовтИсп.ОсновнаяВалютаУчета() Тогда
	...
	Если УчитыватьВДоходах Тогда
		...
		Если ВалютаНазначения <> ОбщийПовтИсп.ОсновнаяВалютаУчета() Тогда
